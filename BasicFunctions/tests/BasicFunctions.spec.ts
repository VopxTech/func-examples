...
describe('BasicFunctions', () => {
    ...
    beforeEach(async () => {
        ...
        const deployResult = await basicFunctions.sendDeploy(deployer.getSender(), toNano('0.05'));
    ...
    it('IF Statement: should increase counter', async () => {
        ...
        for (let i = 0; i < increaseTimes; i++) {
            ...
            const increaseResult = await basicFunctions.sendIfStatement(increaser.getSender(), {
                increaseBy,
                value: toNano('0.05'),
            });
    ...
    it('Repeat Loop: it should increase counter', async () => {
        ...
        const increaseResult = await basicFunctions.sendRepeatLoop(increaser.getSender(), {
            increaseBy,
            value: toNano('0.05'),
        });
    ...
    it('While Loop: it should increase counter', async () => {
        ...
        const increaseResult = await basicFunctions.sendWhileLoop(increaser.getSender(), {
            limit,
            value: toNano('0.05'),
        });
    ...
    it('Until Loop: it should increase counter', async () => {
        ...
        const increaseResult = await basicFunctions.sendUntilLoop(increaser.getSender(), {
            limit,
            value: toNano('0.05'),
        });
